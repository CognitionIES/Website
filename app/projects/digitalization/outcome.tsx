      ...
      <section className="w-full py-8 sm:py-10 lg:py-6 relative bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            <div className="relative h-[320px] md:h-[460px] mt-8 w-full rounded-xl shadow-md overflow-hidden">
              <Image
                src={outcomeImage}
                alt="Outcome Image"
                fill
              ...
              <div className="mt-20 overflow-x-auto">
                <table className="w-full text-center border-collapse">
                  <tbody>
                    ...
                    <tr>
                      <td className="px-4 py-2 border bg-[#00b4d8]/20 border-gray-100">
                        <span className="font-semibold"></span> Layout Error
                        Rate
                      </td>
                      <td className="px-4 py-2 border bg-[#00b4d8]/20 border-gray-100">
                        ~8%

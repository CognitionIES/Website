...
//             <motion.h2
//               className="text-4xl font-bold mb-6 flex items-center gap-2  text-trasnparent"
...
//             <motion.h2
//               className="text-4xl font-bold mb-6 flex items-center gap-2 bg-gradient-to-r from-[#003C46] to-[#0098af] bg-clip-text  text-transparent"
//               initial={{ x: -50, opacity: 0 }}
//               animate={{ x: 0, opacity: 1 }}
...
// export default PCMKeyFindings;"use client";

    ...
    <div className="max-w-7xl mx-auto px-4 py-12 lg:w-5/6">
      ...
      <section className="mb-12">
        ...
        <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-3xl font-light text-justify">
          At Cognition, our Piping Stress Analysis services are dedicated to ensuring the safety, reliability, and longevity of piping systems in industrial plants. We employ advanced analytical techniques to evaluate stress under various conditions, optimizing design and supporting structures to meet stringent standards. With deep expertise, our team collaborates with you to address complex challenges, from high-pressure systems to seismic loads, delivering tailored solutions that enhance operational efficiency and compliance. Whether for new designs or existing upgrades, we provide comprehensive stress analysis to safeguard your infrastructure.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <p className="text-base md:text-lg text-gray-600 leading-relaxed mb-6 max-w-3xl font-light text-justify">
          We provide a comprehensive set of services to ensure your success in Piping Stress Analysis. Here’s how we can support you:
        </p>

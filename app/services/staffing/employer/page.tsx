...
//           {/* Benefits Section */}
//           <section className="py-8  rounded-lg   animate-on-scroll">
...
//                     <div className="mb-2 flex items-center justify-center w-16 h-16 rounded-full bg-[#0098AF]/10 text-[#0098AF]">
//                       {benefit.icon}
//                     </div>
//                     <div className="bg-white p-2 rounded-lg shadow-md transition-all duration-300 hover:shadow-lg h-[120px]">
//                       <h3 className="mt-4 bg-white font-semibold text-lg text-[#003C46]">
//                         {benefit.title}
//                       </h3>
...
//         <div className="bg-white rounded-lg shadow-md transition-all duration-300 hover:shadow-lg h-[120px] sm:w-[190px] flex flex-col justify-center items-center">

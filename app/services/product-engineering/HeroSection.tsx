...
export default function HeroSection() {
  const { TITLE, SUBTITLE } = PRODUCT_ENGINEERING_CONSTANTS.HERO;
  const { FADE_IN } = PRODUCT_ENGINEERING_CONSTANTS.ANIMATIONS;

  // Explicit background image (replace with your preferred image if needed)
  const backgroundImage = "https://images.unsplash.com/photo-1581092921461-eab62e97a780?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80"; // Engineering-themed image
  ...
  return (
    <section>
      <div className="relative h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5 bg-[url('/images/engineering-pattern.jpg')] bg-repeat" /> {/* Optional pattern */}

...
// This component shows info about plant engineering with an image
import { motion } from "framer-motion";
import Image from "next/image";
import { PLANT_ENGINEERING_CONSTANTS } from "@/constants/plant-engineering/constants";

export default function AboutSection() {
  const { TITLE, DESCRIPTION_1, DESCRIPTION_2, IMAGE } = PLANT_ENGINEERING_CONSTANTS.ABOUT;
    ...
    <section className="py-12 md:py-16 lg:py-20 bg-[#F5FDFF]">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <Image src={IMAGE} alt="Engineering services" fill className="object-cover rounded-lg" />
          </motion.div>
        </div>
      </div>
    </section>

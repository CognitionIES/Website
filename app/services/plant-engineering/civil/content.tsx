    ...
    <div className="max-w-7xl mx-auto px-4 py-16 lg:w-5/6">
      ...
      <section className="mb-16">
        ...
        <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl font-light">
          At Cognition, our Civil Engineering services are dedicated to
          delivering robust, efficient, and sustainable solutions for site
          development, infrastructure, foundations, and industrial buildings. We
          prioritize seamless integration with your project needs, ensuring
          safety and functionality at every step. With years of experience, our
          team collaborates closely with you to tackle challenges like tough
          terrains or tight schedules, ensuring smooth execution from start to
          finish.
        </p>
      </section>
      ...
      <section className="mb-16 relative">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-6 font-light max-w-3xl">
          We leverage industry-leading tools like AutoCAD, STAAD.Pro, and Civil
          3D to deliver precise and efficient civil engineering solutions.
        </p>
      ...
      <section className="mb-16">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#0098AF]  tracking-tight animate-slide-up">
          What We Offer
        </h2>
        <p className="text-lg text-gray-700 leading-relaxed mb-8 max-w-3xl font-light">
          ...
          Civil Engineering. Here’s how we can support you:
        </p>
        <div className="grid  grid-cols-1 md:grid-cols-2 gap-2">
          <ul className="space-y-2">
            {/* Category 1: Site Development & Infrastructure */}
            <li className="flex items-start gap-3 group">
              <span className="text-[#0098AF] text-xl transition-transform duration-300 group-hover:scale-110">
                ➢
              </span>
          ...
          <ul className="space-y-2">
            ...
            <li className="flex items-start gap-3 ml-6">
              <span className="text-[#0098AF] text-base">•</span>
              <span className="text-gray-700 font-light leading-relaxed">
                Admin Buildings, Canteens, Utility Blocks, and Non-Plant
                Structures
              </span>
            </li>
          </ul>

...
const benefits = [
  {
    ...
    description: "Cut quoting time from hours to minutes with automated workflows and intelligent templates.",
  },
  {
    icon: <Zap />,
    title: "Proactive Service Offerings",
    description: "Predict maintenance needs and engage customers proactively with data-driven insights.",
  },
  {
    icon: <LineChart />,
    title: "AI-Led Price Insights",
    description: "Optimize margins and discounts with AI guidance to maximize profitability.",
  },
  {
    icon: <Target />,
    title: "Scientific Pipeline Management",
    description: "Fill your pipeline with targeted opportunities and increase conversion rates.",
  },
  {
    icon: <Layers />,
    title: "Mass Customization",
    description: "Design next-gen, segment-specific service offerings without complexity.",
  },
];
      ...
      <div className="container max-w-7xl mx-auto">
        <div className="text-center max-w-3xl py-14  mx-auto mb-16 animate-fade-in-up">
          ...
          <p className="text-[#5b5b5b]">
            Our platform delivers tangible business benefits that drive revenue growth and operational excellence.
          </p>
        </div>
...
const BenefitCard = ({ 
  ...
  return (
    ...
    >
      ...
      <div>
        <h3 className="text-xl font-semibold font-medium tracking-tight text-[#003C46] mb-3">{title}</h3>

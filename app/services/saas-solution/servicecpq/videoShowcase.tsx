      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12 animate-fade-in-up">
          ...
          <p className="text-[#5b5b5b] mb-8">
            Experience our platform&apos;s capabilities through this quick demonstration
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="absolute bottom-5 -right-6 bg-[#00b4d8] text-white p-2 rounded-lg shadow-lg animate-subtle-bounce z-10" style={{ animationDelay: "0.5s" }}>
            <Youtube className="h-5 w-5" />
          </div>

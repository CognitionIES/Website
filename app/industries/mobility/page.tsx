          ...
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            <div className="mb-12">
              ...
              <motion.div
                ...
                transition={{ duration: 1000, repeat: Infinity, repeatType: "reverse" }}
                ...
                {faqs.map((faq, index) => (
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 1000, delay: index * 0.1, repeat: Infinity, repeatType: "reverse" }}
            ...
            <motion.div
              ...
              transition={{ duration: 2000, repeat: Infinity, repeatType: "reverse" }}

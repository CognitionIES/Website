...
const ApplicationForm = () => {
  ...
  return (
    <section id="application" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle">
            We&apos;re seeking talented individuals to join our innovative team. Apply now and be part of our journey!
          </p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="firstName" className="text-[#003C46] font-medium">
                ...
                <div className="space-y-2">
                  <Label htmlFor="lastName" className="text-[#003C46] font-medium">
              ...
              {/* Location */}
              <div className="space-y-2">
                <Label htmlFor="location" className="text-[#003C46] font-medium">
                ...
                <div className="border-2 border-dashed border-[#5B5B5B]/30 rounded-lg p-4 text-center">
                  ...
                  <Label htmlFor="resume" className="cursor-pointer flex flex-col items-center">
                    ...
                    <span className="text-[#5B5B5B] text-sm">
                      {formData.resume ? `${(formData.resume.size / 1024 / 1024).toFixed(2)} MB` : 'PDF, DOC, DOCX (Max 5MB)'}
                    </span>
                  </Label>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 pt-2">
                ...
                <div className="space-y-1 leading-none">
                  ...
                  >
                    I agree to the <a href="#" className="text-[#0098AF] hover:underline">Privacy Policy</a> and consent to having my personal data processed for recruitment purposes.
                  </Label>
                </div>
              </div>

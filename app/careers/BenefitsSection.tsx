      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-[#5B5B5B]  max-w-2xl mx-auto">
            We believe in taking care of our team with benefits
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-2 max-w-7xl px-4 sm:px-6 lg:px-8  mx-auto">
          {ITEMS.map((benefit, index) => (
            <div
              key={index}
              className="bg-white rounded-xl p-4 sm:p-4 sm:px-6 shadow-sm border border-gray-100 card-hover animate-slide-up"

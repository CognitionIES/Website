...
// This component shows the hero section with an image and intro text
  ...
  return (
    <section>
      <div className="relative h-[500px] overflow-hidden">
        {/* Background image */}
        <Image src={IMAGE} alt="Contact Us Hero" fill className="object-cover" priority />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 h-full flex flex-col justify-center">
          ...
          <nav className="self-start mb-6 flex items-center space-x-2 text-sm font-light text-white/80">
            ...
            <Link href="/contact" className="hover:text-[#99D5DF] transition-colors duration-200">
              Contact Us
            </Link>
          </nav>
